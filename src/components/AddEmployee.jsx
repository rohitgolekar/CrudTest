...
function AddEmployee() {
    ...
    const AddEmployee = async () => {
        try {
            ...
            const response = await axios.post("http://localhost:3004/Employees", { Fname, Lname, Email });
    ...
    return (
        <>
            <div className="container my-5" style={{boxShadow: "5px 5px 20px 0px"}}>
                <div className="row p-4 bg-dark text-white AddEmployee">
                    ...
                    <div className="col-md-6 mx-auto">
                        ...
                        <div className="form-group my-2">
                            ...
                            <button className='btn btn-success mx-2' onClick={backToList}>Employee List</button>
                        </div>
                    </div>
                </div>
            </div>
